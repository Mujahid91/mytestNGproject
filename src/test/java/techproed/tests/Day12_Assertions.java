...
public class Day12_Assertions {
    ...
    public void hardAssert(){
        //import org.testing.Assert; Hard assertion
    ...
    public void softAssert(){
        ...
        softAssert.assertEquals(5,5);//pass. This will NOT be on the console because is PASS
        ...
        What is difference between hard soft assertion?
          HardAssert= If hard assert fails, the test case will not continue to run.
